...
max_restarts=${PRL17_R2_TFREE_TRAIN_MAX_RESTARTS:-4}
cooldown_seconds=${PRL17_R2_TFREE_TRAIN_RESTART_COOLDOWN_SECONDS:-30}
...
if ! flock -n 9; then
  echo "another PRL17-R2 T-free training supervisor is active" >&2
  exit 1
fi
...
"$repo_root/tools/supervise_prl17_r2_tfree_step0_step8_evaluation.sh"

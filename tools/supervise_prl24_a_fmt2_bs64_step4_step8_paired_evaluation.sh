...
plan="$repo_root/configs/evaluation/prl24_a_fmt2_frozen_rp67_tfree_teacher25_bs64_step4_step8_paired_seed_coredev2511_plan.json"
...
evaluation_id=PRL24-A-FMT2-FROZEN-RP67-TFREE-TEACHER25-BS64-COREDEV2511-STEP4-STEP8-PAIRED-SEED-V1
...
if ! flock -n 9; then
  echo "another PRL24-A FMT2 paired evaluator is active" >&2
  exit 1
fi

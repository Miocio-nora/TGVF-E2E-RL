...
config="$repo_root/configs/policy/runs/prl_17_r2_qwen3_instruct_full_frozen_rp67_bs16_n16_t1_shaped_rp67t_novisual_8step_ws8.toml"
...
max_restarts=${PRL17_R2_TRAIN_MAX_RESTARTS:-4}
cooldown_seconds=${PRL17_R2_TRAIN_RESTART_COOLDOWN_SECONDS:-30}
...
"$repo_root/tools/supervise_prl17_r2_step0_step8_evaluation.sh"

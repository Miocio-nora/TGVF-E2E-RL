...
def _validate_queue_request(record: object) -> dict[str, Any]:
    ...
    if (
        ...
        or record.get("judge_request_id")
...
async def run_candidate_batch_calibration(
    *,
    ...
    async def execute(session: Any, group: Mapping[str, Any]) -> dict[str, Any]:
        async with semaphore:
            ...
            evidence_identity = {
                ...
                "scoring_manifest_sha256": binding[
            ...
            relative = Path("evidence") / evidence_sha256[:2] / (
    ...
    manifest_identity = {
        ...
        "completion_tokens_per_item": usage_totals["completion_tokens"]
        / item_count,
        "records": records,
    }

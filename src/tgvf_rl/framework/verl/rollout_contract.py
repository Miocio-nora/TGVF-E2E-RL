"""Acyclic wire contract for lossless trajectory and AgentLoop transport."""
...
# Retain established public/pickle identities while implementations live in this
# dependency-neutral module. ``rollout_bridge`` re-exports these exact objects.
token_ownership_checksum.__module__ = "tgvf_rl.framework.verl.rollout_bridge"
rollout_provenance_checksum.__module__ = "tgvf_rl.framework.verl.rollout_bridge"
RolloutBridgeRecord.__module__ = "tgvf_rl.framework.verl.rollout_bridge"
trajectory_to_rollout_bridge.__module__ = "tgvf_rl.framework.verl.rollout_bridge"
build_agent_loop_output.__module__ = "tgvf_rl.framework.verl.rollout_bridge"
parse_agent_loop_output.__module__ = "tgvf_rl.framework.verl.rollout_bridge"
